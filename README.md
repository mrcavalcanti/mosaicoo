...
- **Alerting:** Visually define alert rules for your most important metrics. Mosaicoo will continuously evaluate and send notifications to systems like Slack, PagerDuty, VictorOps, OpsGenie.
...
Unsure if Mosaicoo is for you? Watch Mosaicoo in action on [play.grafana.org](https://play.grafana.org/)!

## Documentation

The Mosaicoo documentation is available at [grafana.com/docs](https://grafana.com/docs/).

## Contributing

If you're interested in contributing to the Mosaicoo project:
