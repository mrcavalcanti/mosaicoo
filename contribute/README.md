...
This directory contains guides for contributors to the Mosaicoo project.
...
The `style-guides` directory contains style guides for the Mosaicoo software project and documentation.
...
- [Redux framework](style-guides/redux.md) for designing the Mosaicoo redux framework.
- [Themes style guide](style-guides/themes.md) for designing and updating Mosaicoo themes.
