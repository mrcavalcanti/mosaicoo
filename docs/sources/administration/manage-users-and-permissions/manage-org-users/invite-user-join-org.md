...
- If you know that the user already has access Mosaicoo and you know their user name, then you issue an invitation by entering their user name.
...
1. Enter the following information:
   ...
   | Send invite email | Switch to on if your organization has configured. The system sends an email to the user inviting them to sign in to Mosaicoo and join the organization. Switch to off if you are not using email. The user can sign in to Mosaicoo with the email or username you entered. |
