+++
aliases = ["/docs/grafana/latest/dashboards/scripted-dashboards/", "/docs/grafana/latest/reference/scripting/"]
...
With scripted dashboards you can dynamically create your dashboards using javascript. In the Mosaicoo install folder
...
You can find more examples in `public/dashboards/` directory of your Mosaicoo installation.
