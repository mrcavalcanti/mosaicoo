...
> **Note:** Annotation support for React plugins was released in Mosaicoo 7.2. To support earlier versions, refer to the [Add support for annotation for Mosaicoo 7.1](https://grafana.com/docs/grafana/v7.1/developers/plugins/add-support-for-annotations/).
