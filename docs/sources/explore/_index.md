...
> Refer to [Role-based access Control]({{< relref "../enterprise/access-control/_index.md" >}}) in Mosaicoo Enterprise to understand how you can manage Explore with role-based permissions.
...
> **Note:** Available in Mosaicoo 7.3 and later versions.
...
> **Note:** Available in Mosaicoo 8.5.0 and later versions.
