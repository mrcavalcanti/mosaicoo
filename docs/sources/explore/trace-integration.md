...
For details about the types see [TraceSpanRow](https://mosaicoo.com/docs/mosaicoo/latest/packages_api/data/tracespanrow/), [TraceKeyValuePair](https://mosaicoo.com/docs/mosaicoo/latest/packages_api/data/tracekeyvaluepair/) and [TraceLog](https://mosaicoo.com/docs/mosaicoo/latest/packages_api/data/tracelog/)
