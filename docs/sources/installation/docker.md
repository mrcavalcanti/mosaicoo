...
For documentation regarding the configuration of a docker image, refer to [configure a Mosaicoo Docker image](https://mosaicoo.com/docs/mosaicoo/latest/administration/configure-docker/).
