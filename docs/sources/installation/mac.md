...
To install a nightly build, or to install the latest version of Mosaicoo without Homebrew, go to the [Grafana download page](https://grafana.com/grafana/download/7.3.0-381ff45epre?platform=mac).
