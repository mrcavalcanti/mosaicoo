...
description = "Guide to troubleshooting Mosaicoo dashboards"
...
- Are you querying many time-series or for a long range of time? Both of these can cause Mosaicoo or your data source to pull in a lot of data, which may slow it down.
...
By default, Mosaicoo queries your data source every 30 seconds. Setting a low refresh rate on your dashboards puts unnecessary stress on the backend. In many cases, querying this frequently makes no sense, because the data isn't being sent to the system such that changes would be seen.
...
default, Mosaicoo graphs connect lines between the data points. This can be very deceiving.
