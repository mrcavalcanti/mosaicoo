...
This section explains how to create annotations in the Time series panel. To read more about annotations support in Mosaicoo please refer to [Annotations]({{< relref "../../dashboards/annotations.md" >}}).
