...
Component for showing a value based on a [DisplayValue](https://mosaicoo.com/docs/mosaicoo/latest/packages_api/data/displayvalue/#displayvalue-interface).
...
An example usage is in the [Stat panel](https://mosaicoo.com/docs/mosaicoo/latest/panels/visualizations/stat-panel/).
