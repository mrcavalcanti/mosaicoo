...
These are the sources for the Docker image that we use for the Mosaicoo build containers. The image source itself
...
In order to build and publish the Mosaicoo build Docker image, execute the following:
