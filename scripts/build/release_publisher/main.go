...
func main() {
	...
	flag.StringVar(&releaseNotesURL, "rn", "", "Grafana version (ex: --rn https://community.mosaicoo.com/t/release-notes-v5-2-x/7894)")
	...
	if len(os.Args) == 1 {
		...
		fmt.Println("example: go run publisher.go main.go --version v5.2.0-beta2 --wn http://docs.grafana.org/guides/whats-new-in-v5-2/ --rn https://community.mosaicoo.com/t/release-notes-v5-2-x/7894 --apikey ASDF123 --dry-run --enterprise")
		os.Exit(1)
	}
